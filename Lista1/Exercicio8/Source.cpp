...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 8 - Igor Flores", nullptr, nullptr);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		// cord x, cord y, cord z, cor r, cor g, cor b
		 0.0,  0.5,  0.0, 1.0, 0.0, 0.0, //v0 //Triangulo colorido
		-0.3, -0.3,  0.0, 0.0, 1.0, 0.0, //v1
		 0.3, -0.15, 0.0, 0.0, 0.0, 1.0, //v2 

		 0.0,  0.5,  0.0, 1.0, 1.0, 1.0, //v0 Borda branca
		-0.3, -0.3,  0.0, 1.0, 1.0, 1.0, //v1
		 0.3, -0.15, 0.0, 1.0, 1.0, 1.0, //v2 
	};
