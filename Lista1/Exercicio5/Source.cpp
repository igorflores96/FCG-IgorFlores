...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 5 - Igor Flores", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Definindo cor e desenhando line
		shader.setVec4("inputColor", 1.0f, 1.0f, 0.0f, 1.0f);
		glDrawArrays(GL_LINE_LOOP, 0, 3);
		glDrawArrays(GL_LINE_LOOP, 3, 3); //Usamos 3 aqui por ser o 3 próximos após o 3 do inicio. Não 6. Se colocassemos 3,6 seria começar do 3 e contornar até o 6 próximos.

		//Definindo cor e desenhando pontos
